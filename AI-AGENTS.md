...
| `/resonite` `quest` | Components v2 message stating **Quest / standalone VR is not supported** and **there are no plans** for Quest support; directs users to PC VR. Implemented in `src/commands/resonite/resoniteQuest.ts`. |
